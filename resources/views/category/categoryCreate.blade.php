        ...
        <div class="card-body">
            <form action="{{ route('category-store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input id="category_name" type="text" class="form-control rounded-lg" name="category_name" placeholder="Category Name" aria-label="category_name" aria-describedby="basic-addon1">
                </div>
                <div class="mb-3">
