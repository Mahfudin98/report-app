...
Route::controller(RajaOngkirController::class)->group(function () {
    ...
    Route::post('/member-address-add', 'addMemberAddress');
});
...
Route::controller(ImageHeadlineController::class)->group(function () {
    Route::middleware(['auth:sanctum'])->group(function () {
        Route::get('/image-headline-data', 'indexData');
        Route::post('/image-headline-store', 'store');
        Route::delete('/image-headline-destroy/{id}', 'destroy');
    });
...
Route::controller(ApiProductsController::class)->group(function () {
    ...
    Route::get('/product-category-customer', 'category');
...
Route::controller(PagesController::class)->group(function () {
    ...
    Route::get('/member-page-view-lp/{id}', 'pageViewLP');
});
